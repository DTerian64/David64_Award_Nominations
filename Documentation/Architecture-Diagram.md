...
graph TB
    ...
    subgraph PUB["🌐 Public Internet"]
        TENANTS["👥 Tenant Users<br/>acme-awards.terianix.ai<br/>sandbox-awards.terianix.ai<br/>dev-awards.terianix.ai"]
    ...
    subgraph EDGE["☁️ Azure Edge Network — PUBLIC INGRESS ONLY"]
        DNS_Z["🌐 Azure DNS Zone<br/>terianix.ai<br/>Per-tenant CNAME records<br/>Managed by Terraform"]
