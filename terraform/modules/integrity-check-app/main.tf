# Service-specific composition for the live integrity inference worker.
# Owns its identity, least-privilege Azure access, runtime contract, and the
# underlying event-driven Container App.
...
module "container_app" {
  ...
  environment_variables = [
    ...
    { name = "AZURE_OPENAI_ENDPOINT", value = var.openai_endpoint },
    { name = "AZURE_OPENAI_DEPLOYMENT", value = var.openai_deployment },
