...
class _ExtrasToMessageFilter(logging.Filter):
    ...
    Example output:
        "App_Log: Fraud assessment complete {"nomination_id": 13699, "fraud_score": 0.12}"
    """
...
def setup_logging():
    ...
    try:
        ...
        _svc = os.getenv("CONTAINER_APP_NAME") or "integrity-check"
        root_logger.addHandler(
            NominationLogDBHandler(insert_nomination_logs, service=_svc, actor="svc:integrity-check")
        )
    except Exception:
