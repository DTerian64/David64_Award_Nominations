...
def setup_logging():
    ...
    try:
        import os
        from utils.sqlhelper import insert_nomination_logs
        from utils.nomination_log_handler import NominationLogDBHandler
        _svc = os.getenv("CONTAINER_APP_NAME") or "payroll-broker"
        root_logger.addHandler(
            NominationLogDBHandler(insert_nomination_logs, service=_svc, actor="svc:payroll-broker")
        )
    except Exception:
